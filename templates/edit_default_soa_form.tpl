...
<tr><td>
    ...
    <tr bgcolor="#cccccc">
        <td align="center">Edit Default SOA record</td>
    </tr>
    </table>
    ...
    <tr bgcolor="#eeeeee">
        ...
        <td align="left"><input type="text" name="tldhost" value="{$soa_array.tldhost}"></td>
        <td>defaults:</td>
    </tr>
    <tr bgcolor="#eeeeee">
        <td nowrap>Contact Address</td>
        <td align="left"><input type="text" name="tldemail" value="{$soa_array.tldemail}"></td>
