<table width="70%" border=0 cellspacing=5 cellpadding=3 bgcolor="white">
            ...
            <table width="100%" border=0 cellspacing=0 cellpadding=3 bgcolor="#cccccc">
                <tr valign="top" bgcolor="#cccccc">
                    <td align="left" colspan="2">
                        ...
                        Listing {$first_location} - {$last_location} of {$totallocationss} Locations {$searchtexttag|escape:'html'}</td>
                    ...
                    <td align="right" colspan="2">
                        <form action="{$php_self}">
                            ...
                            <input type="hidden" name="mode" value="locations">
    ...
    <tr bgcolor="#cccccc">
        <td align="left" colspan="3">Records</td>
        <td align="right" width="5%" nowrap><a href="{$add_location_url}">add location</a></td>
...
{foreach from=$out_array item=row}
    <tr bgcolor="{cycle values="#ffffff,#dcdcdc"}">
        <td width="5%" ><a href="{$row.edit_url}">{$row.location}</td>
        <td nowrap>{$row.prefix}</td>
