...
class HW_IDS {
	 ...
	 * @access private
	 */
	public function _populate_cache() {
		if ($this->_use_json) {
	 ...
	 * @access private
	 */
	public function _fetchUsbIdsLinux() {
	 ...
	 * @access private
	 */
	public function _fetchPciIdsLinux() {
	 ...
	 * @access private
	 */
	public function _fetchPciNames() {
	 ...
	 * @access private
	 */
	public function _fetchUsbNames() {
	 ...
	 * @access private
	 */
	public function _is_cache_worthy() {
		$pci_good = true;
	 ...
	 * @access private
	 */
	public function _fetchPciIdsPciConf() {
		try {
